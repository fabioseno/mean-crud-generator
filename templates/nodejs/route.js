...
module.exports = function (router) {
    ...
    // Add
    router.put('/{plural_entity_name}', auth.isLogged, {required_middleware}{middleware_list}{controller_name}.add);
    
    // Update
    router.post('/{plural_entity_name}/:id', auth.isLogged, {required_middleware}{middleware_list}{controller_name}.update);
